  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-20">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-4 px-6 py-6 sm:px-10 lg:px-[138px] lg:py-[53px]">
        <div className="relative h-[47px] w-[110px] shrink-0">
          <Image
        ...
        <div className="flex items-center gap-4">
          <div className="hidden items-center gap-4 rounded-none border border-white/12 bg-white/8 px-5 py-3.5 md:flex">
